...
agent1_prompt_template = ChatPromptTemplate.from_messages([
    SystemMessagePromptTemplate.from_template(
        "You are an AI assistant specialized in mental health and OCD. Provide a direct, concise answer to the user's question based on the relevant information provided. The context provided will include relevant questions and answers that you can refer to and also relevant mental fitness information you can use when generating your answer. Do not include any analysis steps, thought processes, or explanations of your answer. Just give the final, helpful response."
    ),
